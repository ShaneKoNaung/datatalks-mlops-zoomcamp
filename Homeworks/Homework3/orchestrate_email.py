...
def train_best_model(
    ...
    with mlflow.start_run():
        ...
        markdown_rmse_report = f"""# Duration Prediction RMSE Report
...
def main_flow_email(
    ...
    email_send_message(
        ...
        subject=f"Training Status",
        msg=f"Training finished in flow_run_name : {flow_run_name}",
